CUBE = mesh_box(1.2, 1.2, 1.2)
COOL = material_basic(vec4(0.15, 0.5, 1.0, 1.0))
WARM = material_basic(vec4(1.0, 0.28, 0.06, 1.0))
LEFT = node_add(CUBE, COOL)
RIGHT = node_add(CUBE, WARM)
