CUBE_MESH = mesh_box(1.4, 1.4, 1.4)
BLUE_MATERIAL = material_basic(vec4(0.15, 0.55, 1.0, 1.0))
ORANGE_MATERIAL = material_basic(vec4(1.0, 0.35, 0.08, 1.0))
LEFT_CUBE = node_add(CUBE_MESH, BLUE_MATERIAL)
RIGHT_CUBE = node_add(CUBE_MESH, ORANGE_MATERIAL)
